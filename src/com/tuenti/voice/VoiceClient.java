...
{
//----------------- USERNAME-PASS-CONNECTION SETTINGS ------------------------------
...
// ------------------------------ FIELDS ------------------------------
    ...
    //test zone
    public final static int CALL_HANG_UP = 6;
    ...
    private final static String TAG = "jlib";
...
// -------------------------- OTHER METHODS --------------------------
    ...
    public boolean call( String remoteUsername )
    {
    ...
    //test zone
    public boolean login( String username, String password, String server, boolean useSsl )
    {
